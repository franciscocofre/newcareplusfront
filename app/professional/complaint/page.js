...
export default function ProfessionalComplaintsPage() {
  ...
  useEffect(() => {
    const fetchComplaints = async () => {
      ...
      try {
        const response = await axios.get("https://newcareplusback.onrender.com/api/complaints/professional", {
        ...
        setError(
          err.response?.data?.error || "No se pudieron cargar los reclamos. Intenta nuevamente."
        );
      } finally {
        setLoading(false);
      }
  ...
  return (
    <div className="container mx-auto p-6">
      <div className="flex justify-between items-center mb-6">
        ...
        <Link href="/professional/complaint/new">
